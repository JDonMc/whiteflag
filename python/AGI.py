...
datasets.DatasetDict({"train": datasets.Dataset.from_dict({"features": ['question', 'answer', 'passage'], "num_rows": 9427}), "validation": datasets.Dataset.from_dict({"features": ['question', 'answer', 'passage'], "num_rows": 3270 })})
